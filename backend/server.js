...
const app = express();
app.get('/', (req, res) => {
  res.send('🟢 Food Supply Chain Backend is running!');
});

app.use(express.json());
app.use(cors({
  origin: ['http://localhost:3000', 'http://localhost:5173', 'http://127.0.0.1:5173' ,'https://frovitraxcom.vercel.app/' , 'https://frovitrax.netlify.app/'],
  credentials: true
}));
